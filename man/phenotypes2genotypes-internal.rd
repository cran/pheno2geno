...
\alias{createMix}
\alias{analyseLineVariance}
\alias{applyFunctionToFile}
...
\alias{readSingleFile}
\alias{reciproce}
\alias{rearrangeMarkers}
\alias{selectByLine}
\alias{selectPhenotypes}
\alias{selectChr}
\alias{simulateParentalPhenotypes}
\alias{tTestByLine}
\alias{twoGenosModel}
\alias{writeSingleFile}

\alias{add.to.populationSubAnnots.internal}
...
\alias{getMarkerOffsets.internal}
